...
export const Icons = {
  ...
  supabase: (props: IconProps) => (
    <img
      src="https://cdn.brandfetch.io/idsSceG8fK/w/436/h/449/theme/dark/symbol.png?c=1bxid64Mup7aczewSAYMX&t=1668081497517"
      alt="Supabase"
      className={props.className}
      style={props.style}
    />
  ...
  mysql: (props: IconProps) => (
    <img src="https://logo.svgcdn.com/l/mysql.svg" alt="MySQL" className={props.className} style={props.style} />
  ),
  ...
  zod: (props: IconProps) => (
    <img src="https://logo.svgcdn.com/l/zod.svg" alt="Zod" className={props.className} style={props.style} />
  ),

  zustand: (props: IconProps) => (
    <img
      src="https://logo.svgcdn.com/devicon/zustand-original.svg"
      alt="Zustand"
      className={props.className}
      style={props.style}
    />
  ),
  directus: (props: IconProps) => (
    <img
      src="https://raw.githubusercontent.com/2fasvg/2fasvg.github.io/master/assets/img/logo/directus.io/directus.io.svg"
      alt="Directus"
      className={props.className}
      style={props.style}
    />
  ...
  postman: (props: IconProps) => (
    <img src="https://logo.svgcdn.com/l/postman.svg" alt="Postman" className={props.className} style={props.style} />
  ),
  vscode: (props: IconProps) => (
    <img
      src="https://logo.svgcdn.com/l/visual-studio-code.svg"
      alt="VS Code"
      className={props.className}
      style={props.style}
    />
  ),
  clickup: (props: IconProps) => (
    <img
      src="https://cdn.brandfetch.io/idU6lzwMYA/theme/dark/symbol.svg?c=1bxid64Mup7aczewSAYMX&t=1678376729733"
      alt="ClickUp"
      className={props.className}
      style={props.style}
    />
  ...
  teams: (props: IconProps) => (
    <img
      src="https://logo.svgcdn.com/l/microsoft-teams.svg"
      alt="Teams"
      className={props.className}
      style={props.style}
    />
  ...
  mongodb: (props: IconProps) => (
    <img
      src="https://cdn.brandfetch.io/ideyyfT0Lp/theme/light/idxmboBE0D.svg?c=1bxid64Mup7aczewSAYMX&t=1671109861197"
      alt="MongoDB"
      className={props.className}
      style={props.style}
    />
  ...
  vite: (props: IconProps) => (
    <img
      src="https://cdn.brandfetch.io/idqeSF6CKl/theme/dark/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1767621513504"
      alt="Vite"
      className={props.className}
      style={props.style}
    />
  ...
  prettier: (props: IconProps) => (
    <img src="https://logo.svgcdn.com/l/prettier.svg" alt="Prettier" className={props.className} style={props.style} />
  ),
  eslint: (props: IconProps) => (
    <img src="https://logo.svgcdn.com/l/eslint.svg" alt="ESLint" className={props.className} style={props.style} />
  ),
};
